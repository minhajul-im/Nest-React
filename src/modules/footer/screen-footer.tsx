import { getFooterData } from "./service";
import { FooterLink } from "./components/footer-link";

export const ScreenFooter = async () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="flex gap-4 flex-col justify-center mx-auto w-full">
            ...
            <div className="flex justify-center flex-col">
              <p className="text-sm text-center text-muted-foreground mx-4">
          ...
          <FooterLink links={companyData}>{company}</FooterLink>
          <FooterLink links={settingsData}>{setting}</FooterLink>
          <FooterLink isLink={false} links={contactData}>
            {contact}
          </FooterLink>
        </div>
      </div>

      <p className=" mt-12 pt-6 pb-3 tracking-wide text-center border-t text-sm text-primary sm:order-first sm:mt-0">
        &copy; 2024 Jutlee
      </p>
    </footer>
  );
